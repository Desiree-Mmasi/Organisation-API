...
public class DB {
    ...
    private static String testConnectionString = "jdbc:postgresql://localhost:5432/organisationapi";
    private static String testUser = "moringa";
    private static String testPassword = "1234";
     public static Sql2o sql2o = new Sql2o( testConnectionString, testUser, testPassword);// Comment this out if you are
//    testing your app locally

    // PRODUCTION DATABASE
    private static String connectionString =
            "jdbc:postgresql://ec2-174-129-229-106.compute-1.amazonaws.com:5432/ddsnv9l24nb7pb";
